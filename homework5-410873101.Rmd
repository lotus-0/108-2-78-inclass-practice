...
levelnames <- levels(studentHeights$`年齡層`)
startages <- stringr::str_extract(levelnames , "^[0-9]+")
startages <- as.integer(startages)
names(startages) <- levelnames
startages <- sort(startages)
studentHeights$`年齡層` <- 
