...
strip3 <- "[0-9]"
strip4 <- "號"
practice <- paste0(strip1,strip2,strip3,strip4)
str_extract(addresses , practice)
```
...
str_replace(date , regex_pattern , as.character(westernYear)) -> reformatDate
date <- lubridate::ymd(reformatDate)
```
