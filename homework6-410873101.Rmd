...
map(cpiByIncome, ~ .x$Item) -> list_items
unlist(list_items) -> items
factor(items) -> items
...
```{r ans15}
factor(
  subcategory, levels = c("一.食物類" ,  "二.衣著類", "三.居住類",  "四.交通及通訊類",  "五.醫藥保健類",   "六.教養娛樂類",   "七.雜項類",  "總指數")) -> subcategory
subcategory
```
